// mat4x4.h
#ifndef NGE_MATH_MAT4X4_H
#define NGE_MATH_MAT4X4_H
...
template <typename T>
inline
const typename TMat4x4<T>::Column& TMat4x4<T>::operator[]( uint32 i ) const
{
...
template <typename T>
inline
typename TMat4x4<T>::Column& TMat4x4<T>::operator[]( uint32 i )
{
    assert( i < TMat4x4<T>::COLUMNS );
    return _value[i];
}
