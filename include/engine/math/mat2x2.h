// mat2x2.h
#ifndef NGE_MATH_MAT2X2_H
#define NGE_MATH_MAT2X2_H
...
template <typename T>
inline
const typename TMat2x2<T>::Column& TMat2x2<T>::operator[]( uint32 i ) const
{
...
template <typename T>
inline
typename TMat2x2<T>::Column& TMat2x2<T>::operator[]( uint32 i )
{
    assert( i < TMat2x2<T>::COLUMNS );
    return _value[i];
}
