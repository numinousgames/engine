// vec3.h
#ifndef NGE_MATH_VEC3_H
#define NGE_MATH_VEC3_H
...
/**
 * This protects against template issues where U could also be one of the
 * undesired types thereby hiding another function.
 */
...
class TVec3
{
  public:
    ...
    /**
     * Constructs a 3D copy of the vector.
     *
     * @param v The vector to copy.
     * @tparam U The component type.
     */
...
template <typename T>
inline
const T& TVec3<T>::operator[]( uint32 index ) const
{
...
template <typename T>
inline
T& TVec3<T>::operator[]( uint32 index )
{
    assert( index >= 0 && index < 3 );
    return ( &x )[index];
}
...
template <>
inline
bool operator==( const TVec3<float>& u, const TVec3<float>& v )
{
    return Math::eq( u.x, v.x ) &&
        Math::eq( u.y, v.y ) &&
        Math::eq( u.z, v.z );
}
...
template <>
inline
bool operator==( const TVec3<double>& u, const TVec3<double>& v )
{
    return Math::eq( u.x, v.x ) &&
        Math::eq( u.y, v.y ) &&
        Math::eq( u.z, v.z );
...
template <>
inline
bool operator==( const TVec3<float>& u, const TRef3<float>& v )
{
    return Math::eq( u.x, v.x ) &&
        Math::eq( u.y, v.y ) &&
        Math::eq( u.z, v.z );
...
template <>
inline
bool operator==( const TVec3<double>& u, const TRef3<double>& v )
{
    return Math::eq( u.x, v.x ) &&
        Math::eq( u.y, v.y ) &&
        Math::eq( u.z, v.z );
...
template <>
inline
bool operator==( const TRef3<float>& u, const TVec3<float>& v )
{
    return Math::eq( u.x, v.x ) &&
        Math::eq( u.y, v.y ) &&
        Math::eq( u.z, v.z );
...
template <>
inline
bool operator==( const TRef3<double>& u, const TVec3<double>& v )
{
    return Math::eq( u.x, v.x ) &&
        Math::eq( u.y, v.y ) &&
        Math::eq( u.z, v.z );
...
template <>
inline
bool operator==( const TRef3<float>& u, const TRef3<float>& v )
{
    return Math::eq( u.x, v.x ) &&
        Math::eq( u.y, v.y ) &&
        Math::eq( u.z, v.z );
...
template <>
inline
bool operator==( const TRef3<double>& u, const TRef3<double>& v )
{
    return Math::eq( u.x, v.x ) &&
        Math::eq( u.y, v.y ) &&
        Math::eq( u.z, v.z );
