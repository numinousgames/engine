// mat3x3.h
#ifndef NGE_MATH_MAT3X3_H
#define NGE_MATH_MAT3X3_H
...
class TMat3x3
{
  ...
  public:
     ...
     * @return The column.
     */
    const Column& operator[]( uint32 i ) const;
...
template <typename T>
inline
const typename TMat3x3<T>::Column& TMat3x3<T>::operator[]( uint32 i ) const
{
...
template <typename T>
inline
typename TMat3x3<T>::Column& TMat3x3<T>::operator[]( uint32 i )
{
    assert( i < TMat3x3<T>::COLUMNS );
    return _value[i];
}
