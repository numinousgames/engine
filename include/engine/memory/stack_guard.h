...
class StackGuard
{
  ...
  public:
    ...
    /**
     * Moves the guarded mem to this instance.
     */
    StackGuard( StackGuard<T>&& guard );

    /**
     * Destructs the stack guard and releases the guarded mem.
     */
    ~StackGuard();
    ...
    /**
     * Checks if the guarded mem is null.
     */
    bool operator!() const;

    /**
     * Checks if the guarded mem is not null.
     */
    operator bool() const;
